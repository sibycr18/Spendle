                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="flex flex-col items-center gap-4 text-center bg-white p-8 rounded-xl shadow-xl border border-gray-200">
                            ...
                            <p className="text-base text-gray-600">Loading transactions</p>
                        </div>
                    </div>
                </>
            )}
            <div className="flex-1 space-y-6 max-w-7xl mx-auto px-4 sm:px-6 py-4">
                ...
                <div className="max-w-4xl mx-auto w-full">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        ...
                        <div className="bg-white rounded-lg shadow-md border border-blue-200 px-4 py-3 space-y-1 sm:col-span-2 md:col-span-1">
                ...
                <div className="max-w-2xl mx-auto w-full space-y-4">
                    <div className="border-b border-gray-200">
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
                            ...
                            <button
                                className="w-full sm:w-auto inline-flex items-center justify-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    ...
                    <div className="bg-white rounded-lg shadow-md border border-gray-300 divide-y divide-gray-200">
                        {isLoading ? (
                            ...
                            filteredTransactions.map((transaction) => (
                                <div key={transaction.id} className="px-3 sm:px-4 py-3 hover:bg-gray-50">
                                        ...
                                        <div className="flex items-center justify-between sm:justify-end gap-4">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`p-1 ${transaction.active ? 'text-green-500 hover:text-yellow-500' : 'text-yellow-500 hover:text-green-500'}`}
                                                >
                                                    {transaction.active ? (
