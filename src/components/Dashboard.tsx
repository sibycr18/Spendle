    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 py-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50 text-center sm:text-left">Dashboard</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 [&>*]:h-fit">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-300 dark:border-gray-700 p-4 sm:p-6">
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-50 mb-3">Summary</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-blue-200 dark:border-blue-900">
                            ...
                            <div className="text-base sm:text-lg font-bold text-black dark:text-gray-50">
                                {formatIndianNumber(totalIncome)}
                            </div>
                            <div className={`text-xs font-medium ${calculateTrend(totalIncome, prevTotalIncome) > 0 ? 'text-green-600 dark:text-green-400' : calculateTrend(totalIncome, prevTotalIncome) < 0 ? 'text-red-600 dark:text-red-400' : 'text-black dark:text-gray-50'}`}>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-red-200 dark:border-red-900">
                            ...
                            <div className={`text-xs font-medium ${calculateTrend(totalExpenses, prevTotalExpenses) > 0 ? 'text-red-600 dark:text-red-400' : calculateTrend(totalExpenses, prevTotalExpenses) < 0 ? 'text-green-600 dark:text-green-400' : 'text-black dark:text-gray-50'}`}>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-green-200 dark:border-green-900">
                            ...
                            <div className={`text-xs font-medium ${calculateTrend(totalIncome - totalExpenses, prevTotalIncome - prevTotalExpenses) > 0 ? 'text-green-600 dark:text-green-400' : calculateTrend(totalIncome - totalExpenses, prevTotalIncome - prevTotalExpenses) < 0 ? 'text-red-600 dark:text-red-400' : 'text-black dark:text-gray-50'}`}>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-purple-200 dark:border-purple-900">
                            ...
                            <div className="text-xs font-medium text-black dark:text-gray-50">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-300 dark:border-gray-700 p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-0 mb-4">
                        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-50">Income Sources</h2>
                        <button
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">
                            {incomeSources.length === 0 ? (
                                ...
                                incomeSources.map((source) => (
                                    ...
                                    >
                                        <span className="text-sm font-semibold text-gray-900 dark:text-gray-50">{source.name}</span>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-300 dark:border-gray-700 p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-0 mb-4">
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-50">Expenses</h2>
                    <button
