    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 py-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 text-center sm:text-left">Dashboard</h1>
                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-300 p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-0 mb-4">
                        ...
                        <button
                            ...
                            className="w-full sm:w-auto px-3 py-1.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 shadow-sm text-sm"
                        >
                    ...
                    {/* Income List */}
                    <div className="bg-gray-100 rounded-lg p-3 sm:p-4 shadow-sm border border-gray-200">
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 divide-y divide-gray-200">
                            {incomeSources.length === 0 ? (
                                <div className="px-3 sm:px-4 py-3 text-center text-gray-500">
                                    No income added
                                </div>
                            ) : (
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-300 p-4 sm:p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 [&>*]:h-fit">
                    {CATEGORIES.map((category) => (
                        <div key={category} className="bg-gray-100 rounded-lg p-3 sm:p-4 shadow-sm border border-gray-200 h-fit">
