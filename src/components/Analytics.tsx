    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 py-4">
                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="flex flex-col items-center gap-4 text-center bg-white dark:bg-gray-800 p-8 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700">
                            ...
                            <p className="text-base text-gray-600 dark:text-gray-400">Loading analytics</p>
                        </div>
                    </div>
                </>
            )}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-200 text-center sm:text-left">Analytics</h1>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2">
                    <select
                        ...
                        className="w-full sm:w-auto px-3 py-1.5 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-md text-sm text-gray-700 dark:text-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400"
                    >
